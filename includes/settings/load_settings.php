...
{ ?>
    <div style="max-width: 1024px;">
        ...
        <p style="font-size: 1.2em;">This plugin will act as an add-on for Gravity Forms, allowing you to take payments from your visitors using Open Banking (Europe only), credit/debit cards, Apple Pay and Google Pay.</p>
        <p style="font-size: 1.2em;">For help on using this plugin please consult our <a href="https://en-gb.wordpress.org/plugins/trustistecommerce/#installation">documentation</a>.</p>
        ...
        <p style="font-size: 1.2em;">To get access to your API keys, or if you have any other queries, please email us at <a href="mailto:customerservice@trustisttransfer.com?subject=API Key Request">customerservice@trustisttransfer.com</a>.</p>
    </div>
<?php
}
